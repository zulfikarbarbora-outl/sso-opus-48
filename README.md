...
Opus 48 kbps preview MP3s for the **sso** sample library.
...
- **Files**: 2651 Opus previews
- **Bitrate**: 48 kbps VBR
- **Container**: Ogg Opus (.opus)
- **Source**: [`zulfikarbarbora-outl/sso`](https://github.com/zulfikarbarbora-outl/sso)
- **Branch**: `master`

## URL pattern

```
https://raw.githubusercontent.com/zulfikarbarbora-outl/sso-opus-48/master/<filename>.opus
```
